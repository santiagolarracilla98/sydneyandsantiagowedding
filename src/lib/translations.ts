...
export const translations = {
  en: {
    ...
    intro: {
      ...
      paragraphs: [
        "We truly could not be more excited to bring everyone together to celebrate our love in one place — beautiful Oaxaca.",
        "This weekend will unite two cultures, two families, and two sides of the world, full of flavor, color, music, and energy. It reflects not only where we come from, but the life we are building together.",
        "Our story has unfolded in many chapters. Some of you have been there from the very beginning; others became part of it along the way, through family, friendship, and life's unexpected turns. Each connection has helped guide us here.",
        "It means more than we can express to gather the people who have shaped our lives as we begin this next chapter and become one larger family and community.",
      ],
  ...
  es: {
    ...
    intro: {
      title: 'Bienvenidos a nuestro fin de semana de boda.',
      paragraphs: [
        'No podríamos estar más emocionados de reunir a todos para celebrar nuestro amor en un solo lugar — la hermosa Oaxaca.',
        'Este fin de semana unirá dos culturas, dos familias y dos lados del mundo, lleno de sabor, color, música y energía. Refleja no solo de dónde venimos, sino la vida que estamos construyendo juntos.',
        'Nuestra historia se ha desarrollado en muchos capítulos. Algunos de ustedes han estado desde el principio; otros se unieron en el camino, a través de la familia, la amistad y los giros inesperados de la vida. Cada conexión nos ha ayudado a llegar hasta aquí.',
        'Significa más de lo que podemos expresar reunir a las personas que han marcado nuestras vidas mientras comenzamos este nuevo capítulo y nos convertimos en una familia y comunidad más grande.',
      ],
